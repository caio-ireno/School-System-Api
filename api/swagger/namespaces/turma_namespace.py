...
from turma.turma_model import listar_turmas, adicionar_turma, turma_por_id, atualizar_turma, excluir_turma
...
turma_model = turmas_ns.model("Turma", {
    ...
    "descricao": fields.Integer(required=True, description="Descrição"),
    "ativo": fields.Integer(required=True, description="Ativo"),
